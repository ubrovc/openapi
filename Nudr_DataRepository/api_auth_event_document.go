...
/*
AuthEventDocumentApiService Delete the Authentication Status of a UE
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ueId UE id
@return HTTP response, error
*/

func (a *AuthEventDocumentApiService) DeleteAuthenticationStatus(ctx context.Context, ueId string) (*http.Response, error) {
	var (
